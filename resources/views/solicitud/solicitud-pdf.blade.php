...
<body>
    ...
    <div class="container-fluid">
        <div class="main-header">
            <h1><i class="fas fa-file-alt"></i> Descarga Solicitud SISCORP</h1>
        </div>
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (parseInt(response.error) == 0) {
                            ...
                            Swal.fire({
                                icon: "success",
                                title: "Descarga tu solicitud haciendo clic en el siguiente enlace:",
                                html: `<a href="#">Solicitud Formato PDF</a>`,
                                timerProgressBar: true,
                                backdrop: true,
                                confirmButtonText: 'OK',
                                confirmButtonColor: '#235B4E',
