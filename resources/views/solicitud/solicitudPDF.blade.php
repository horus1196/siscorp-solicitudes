...
<body>
    ...
    <main>
            ...
            <tbody>
                <tr>
                    <td style="text-align: justify">
                        Todos los campos son obligatorios, el formato el formato se debe llenar a computadora o con
                        letra de molde y
                        leginle; la cuenta es personal y el usuariio será responsable del uso que se realice de la misma
        ...
        <table style="width: 100%; border-collapse: collapse; border: 1px solid #000000;">
            <tbody>
                <tr>
                    <td style="font-weight: bold;"> Folio: {{$solicitud["solicitud_folio"]}}</td>
                </tr>
            </tbody>
        </table>
    </main>
